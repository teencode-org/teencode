export const Article = {
  ...
  body: "<p>It's 2017</p><p>The alarms that wake us up, the tools with which we plan our day, our \
        ...
        <p>I love Halloween. The one time of year when everyone wears a mask … not just me. \
        Pretend. You pretend the feelings are there, for the world, for the people around you. \
        Who knows? Maybe one day they will be.</p><p>Makes me a … scientist. <strong> Only you \
        could make those words cute.</strong> <em> He taught me a code.</em>  To survive.</p> \
        <h4>I feel like a jigsaw puzzle missing a piece. And I'm not even sure what the picture should be.</h4> \
        <p>I'm not the monster he wants me to be. So I'm neither man nor beast. I'm something new \
        entirely. With my own set of rules.</p><h4>I'm doing mental jumping jacks</h4>\
